	...
	public function output_sections() {
		...
		public function get_settings() {
				...
				$settings = apply_filters( 'wgac_settings', array(			
					...
					array(
						'name' => __( 'Order amount', 'give-automatic-coupon'),
						'type' => 'number',
						'desc_tip' => __( 'Conditional amount of the order for the coupon to be given.', 'give-automatic-coupon'),
						'default' => '',
						'css' => 'width:150px;',
						'id' => 'wgac_order_amount'				
					),					
					array(
						'type' => 'sectionend',
